...
INSERT INTO DATA_TYPE (ID,DESCRICAO) 
VALUES (1, 'TEXTO');
INSERT INTO DATA_TYPE (ID,DESCRICAO) 
VALUES (2, 'NÚMERO INTEIRO');
INSERT INTO DATA_TYPE (ID,DESCRICAO) 
VALUES (3, 'VALOR MONETÁRIO');
INSERT INTO DATA_TYPE (ID,DESCRICAO) 
VALUES (4, 'DATA/HORA');
INSERT INTO DATA_TYPE (ID,DESCRICAO) 
VALUES (5, 'ARQUIVO TEXTO OU BINÁRIO');
...
ADD ID_DATA_TYPE INTEGER;

ALTER TABLE FORM_FIELDS
ADD FOREIGN KEY (ID_DATA_TYPE) 
